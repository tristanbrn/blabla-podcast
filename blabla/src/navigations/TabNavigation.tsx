    ...
    return (
        <Tab.Navigator 
            tabBarOptions={{
                ...
                inactiveTintColor: theme.color.greyLighter,
                showLabel: false
            }}>
            <Tab.Screen options={{
                tabBarIcon: ({ color }) => (
            ...
            <Tab.Screen options={{
                tabBarIcon: ({ color }) => (
                    <FeatherIcon name="inbox" size={metrics.tabIconSize} color={color} />
                )
            }} 
            name={routes.LIBRARY} 
            ...
            <Tab.Screen options={{
                tabBarIcon: ({ color }) => (
                    <FeatherIcon name="headphones" size={metrics.tabIconSize} color={color} />
                )
            }} 
